...
public class ItemYTrafficLight2Frame extends BaseItemTrafficLightFrame
{
	public ItemYTrafficLight2Frame()
	{
		super("ytraffic_light_2_frame");
	}
	
	@Override
	protected int getGuiID()
	{
		return GuiProxy.GUI_IDs.YTRAFFIC_LIGHT_2_FRAME;
	}
	...
	{
		return ModBlocks.ytraffic_light_2;
	}
}
