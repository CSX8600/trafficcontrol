...
public class ItemOTrafficLight2Frame extends BaseItemTrafficLightFrame
{
	public ItemOTrafficLight2Frame()
	{
		super("otraffic_light_2_frame");
	}
	
	@Override
	protected int getGuiID()
	{
		return GuiProxy.GUI_IDs.OTRAFFIC_LIGHT_2_FRAME;
	}
	...
	{
		return ModBlocks.otraffic_light_2;
	}
}
