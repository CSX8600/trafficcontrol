...
public class ItemOTrafficLight1Frame extends BaseItemTrafficLightFrame
{
	public ItemOTrafficLight1Frame()
	{
		super("otraffic_light_1_frame");
	}
	
	@Override
	protected int getGuiID()
	{
		return GuiProxy.GUI_IDs.OTRAFFIC_LIGHT_1_FRAME;
	}
	...
	{
		return ModBlocks.otraffic_light_1;
	}
}
