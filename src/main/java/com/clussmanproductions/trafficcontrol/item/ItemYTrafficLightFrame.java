...
public class ItemYTrafficLightFrame extends BaseItemTrafficLightFrame {

	public ItemYTrafficLightFrame()
	{
		super("ytraffic_light_frame");
		
	}
	
	@Override
	protected int getGuiID() {
		return GuiProxy.GUI_IDs.YTRAFFIC_LIGHT_FRAME;
	}
	...
	protected BlockBaseTrafficLight getBaseBlockTrafficLight() {
		return ModBlocks.ytraffic_light;
	}
