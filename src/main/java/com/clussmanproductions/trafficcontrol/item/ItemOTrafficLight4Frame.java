...
public class ItemOTrafficLight4Frame extends BaseItemTrafficLightFrame
{
	public ItemOTrafficLight4Frame()
	{
		super("otraffic_light_4_frame");
	}
	...
	{
		return ModBlocks.otraffic_light_4;
	}

	@Override
	protected int getGuiID() 
	{
		return GuiProxy.GUI_IDs.OTRAFFIC_LIGHT_4_FRAME;
	}
}
