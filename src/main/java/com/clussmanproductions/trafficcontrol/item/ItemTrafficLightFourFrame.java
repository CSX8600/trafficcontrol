...
public class ItemTrafficLightFourFrame extends BaseItemTrafficLightFrame
{
	public ItemTrafficLightFourFrame()
	{
	...
	{
		return GuiProxy.GUI_IDs.TRAFFIC_LIGHT_FOUR_FRAME;
	}
}
