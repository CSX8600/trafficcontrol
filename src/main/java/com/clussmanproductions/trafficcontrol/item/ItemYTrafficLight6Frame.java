...
public class ItemYTrafficLight6Frame extends BaseItemTrafficLightFrame
{
	public ItemYTrafficLight6Frame()
	{
		super("ytraffic_light_6_frame");
	}
	...
	{
		return ModBlocks.ytraffic_light_6;
	}

	@Override
	protected int getGuiID() 
	{
		return GuiProxy.GUI_IDs.YTRAFFIC_LIGHT_6_FRAME;
	}
}
