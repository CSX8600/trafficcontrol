...
public class ItemOTrafficLight5Frame extends BaseItemTrafficLightFrame {

	public ItemOTrafficLight5Frame() {
		super("otraffic_light_5_frame");
	}

	@Override
	protected int getGuiID() {
		// TODO Auto-generated method stub
		return GuiProxy.GUI_IDs.OTRAFFIC_LIGHT_5_FRAME;
	}
	...
	protected BlockBaseTrafficLight getBaseBlockTrafficLight() {
		return ModBlocks.otraffic_light_5;
	}
	...
	public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand,
		...
		worldIn.setBlockState(stateAbovePos, ModBlocks.otraffic_light_5_upper.getDefaultState().withProperty(BlockOTrafficLight5Upper.ROTATION, CustomAngleCalculator.getRotationForYaw(player.rotationYaw)));
