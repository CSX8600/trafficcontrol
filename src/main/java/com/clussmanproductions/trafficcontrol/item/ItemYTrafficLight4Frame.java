...
public class ItemYTrafficLight4Frame extends BaseItemTrafficLightFrame
{
	public ItemYTrafficLight4Frame()
	{
		super("ytraffic_light_4_frame");
	}
	...
	{
		return ModBlocks.ytraffic_light_4;
	}

	@Override
	protected int getGuiID() 
	{
		return GuiProxy.GUI_IDs.YTRAFFIC_LIGHT_4_FRAME;
	}
}
