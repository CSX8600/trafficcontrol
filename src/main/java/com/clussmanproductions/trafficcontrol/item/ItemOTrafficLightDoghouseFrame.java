...
public class ItemOTrafficLightDoghouseFrame extends BaseItemTrafficLightFrame {

	public ItemOTrafficLightDoghouseFrame() {
		super("otraffic_light_doghouse_frame");
	}
	
	@Override
	protected int getGuiID() {
		return GuiProxy.GUI_IDs.OTRAFFIC_LIGHT_DOGHOUSE_FRAME;
	}
	...
	protected BlockBaseTrafficLight getBaseBlockTrafficLight() {
		return ModBlocks.otraffic_light_doghouse;
	}
}
