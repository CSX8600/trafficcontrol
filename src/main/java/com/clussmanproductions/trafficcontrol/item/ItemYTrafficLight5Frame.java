...
public class ItemYTrafficLight5Frame extends BaseItemTrafficLightFrame {

	public ItemYTrafficLight5Frame() {
		super("ytraffic_light_5_frame");
	}

	@Override
	protected int getGuiID() {
		// TODO Auto-generated method stub
		return GuiProxy.GUI_IDs.YTRAFFIC_LIGHT_5_FRAME;
	}
	...
	protected BlockBaseTrafficLight getBaseBlockTrafficLight() {
		return ModBlocks.ytraffic_light_5;
	}
	...
	public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand,
		...
		worldIn.setBlockState(stateAbovePos, ModBlocks.ytraffic_light_5_upper.getDefaultState().withProperty(BlockYTrafficLight5Upper.ROTATION, CustomAngleCalculator.getRotationForYaw(player.rotationYaw)));
