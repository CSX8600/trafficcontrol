...
public class OTrafficLight5FrameContainer extends BaseTrafficLightFrameContainer {

	public OTrafficLight5FrameContainer(InventoryPlayer inventory, ItemStack frameStack) {
