...
public class OTrafficLightFrameContainer extends BaseTrafficLightFrameContainer {

	public OTrafficLightFrameContainer(InventoryPlayer inventory, ItemStack frameStack)
	{
