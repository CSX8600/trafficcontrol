...
public class YTrafficLight4FrameContainer extends BaseTrafficLightFrameContainer
{
	public YTrafficLight4FrameContainer(InventoryPlayer inventory, ItemStack frameStack)
	{
