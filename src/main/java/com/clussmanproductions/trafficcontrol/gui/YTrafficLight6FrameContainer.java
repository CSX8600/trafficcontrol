...
public class YTrafficLight6FrameContainer extends BaseTrafficLightFrameContainer {

	public YTrafficLight6FrameContainer(InventoryPlayer player, ItemStack frameStack) {
