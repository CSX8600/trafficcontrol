...
public class YTrafficLight2FrameContainer extends BaseTrafficLightFrameContainer
{	
	public YTrafficLight2FrameContainer(InventoryPlayer inventory, ItemStack frameStack)
	{
