...
public class TrafficLightHorizontalContainer extends BaseTrafficLightFrameContainer
{
    public TrafficLightHorizontalContainer(InventoryPlayer inventory, ItemStack frameStack)
    {
