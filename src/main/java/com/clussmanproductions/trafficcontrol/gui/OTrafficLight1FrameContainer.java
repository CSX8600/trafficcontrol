...
public class OTrafficLight1FrameContainer extends BaseTrafficLightFrameContainer
{
	public OTrafficLight1FrameContainer(InventoryPlayer inventory, ItemStack frameStack)
	{
