...
public class OTrafficLightDoghouseFrameContainer extends BaseTrafficLightFrameContainer {

	public OTrafficLightDoghouseFrameContainer(InventoryPlayer player, ItemStack frameStack) {
