...
public class YTrafficLightDoghouseFrameContainer extends BaseTrafficLightFrameContainer {

	public YTrafficLightDoghouseFrameContainer(InventoryPlayer player, ItemStack frameStack) {
