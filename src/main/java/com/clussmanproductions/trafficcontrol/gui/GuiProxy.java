  ...
  public Object getServerGuiElement(
    ...
    switch (ID) {
      case GUI_IDs.TRAFFIC_LIGHT_FRAME:
        if (
          player.getHeldItemMainhand().getItem() == ModItems.traffic_light_frame
        ) {
          return new TrafficLightFrameContainer(
            player.inventory,
      ...
      case GUI_IDs.TRAFFIC_LIGHT_5_FRAME:
        if (
          ...
          ModItems.traffic_light_5_frame
        ) {
          return new TrafficLight5FrameContainer(
            player.inventory,
            player.getHeldItemMainhand()
          );
        }
      ...
      case GUI_IDs.TRAFFIC_LIGHT_DOGHOUSE_FRAME:
        if (
          player.getHeldItemMainhand().getItem() ==
          ModItems.traffic_light_doghouse_frame
        ) {
          return new TrafficLightDoghouseFrameContainer(
            player.inventory,
            player.getHeldItemMainhand()
          );
        }
      ...
      case GUI_IDs.TRAFFIC_LIGHT_1_FRAME:
        if (
          player.getHeldItemMainhand().getItem() ==
          ModItems.traffic_light_1_frame
        ) {
          return new TrafficLight1FrameContainer(
            player.inventory,
            player.getHeldItemMainhand()
          );
        }
      ...
      case GUI_IDs.TRAFFIC_LIGHT_2_FRAME:
        if (
          player.getHeldItemMainhand().getItem() ==
          ModItems.traffic_light_2_frame
        ) {
          return new TrafficLight2FrameContainer(
            player.inventory,
            player.getHeldItemMainhand()
          );
        }
      ...
      case GUI_IDs.TRAFFIC_LIGHT_4_FRAME:
        if (
          player.getHeldItemMainhand().getItem() ==
          ModItems.traffic_light_4_frame
        ) {
          return new TrafficLight4FrameContainer(
            player.inventory,
            player.getHeldItemMainhand()
          );
        }
      ...
      case GUI_IDs.TRAFFIC_LIGHT_6_FRAME:
        if (
          player.getHeldItemMainhand().getItem() ==
          ModItems.traffic_light_6_frame
        ) {
          return new TrafficLight6FrameContainer(
            player.inventory,
            player.getHeldItemMainhand()
          );
        }
    ...
    switch (ID) {
      ...
      case GUI_IDs.TRAFFIC_LIGHT_FRAME:
        if (
          ...
          return new TrafficLightFrameGui(
            player.inventory,
            player.getHeldItemMainhand()
          );
        }
      ...
      case GUI_IDs.TRAFFIC_LIGHT_5_FRAME:
        if (
          ...
          return new TrafficLight5FrameGui(
            player.inventory,
            player.getHeldItemMainhand()
          );
        }
      ...
      case GUI_IDs.TRAFFIC_LIGHT_DOGHOUSE_FRAME:
        if (
          ...
          return new TrafficLightDoghouseFrameGui(
            player.inventory,
            player.getHeldItemMainhand()
          );
        }
      ...
      case GUI_IDs.TRAFFIC_LIGHT_1_FRAME:
        if (
          ...
          return new TrafficLight1FrameGui(
            player.inventory,
            player.getHeldItemMainhand()
          );
        }
      ...
      case GUI_IDs.TRAFFIC_LIGHT_2_FRAME:
        if (
          ...
          return new TrafficLight2FrameGui(
            player.inventory,
            player.getHeldItemMainhand()
          );
        }
      ...
      case GUI_IDs.TRAFFIC_LIGHT_4_FRAME:
        if (
          ...
          return new TrafficLight4FrameGui(
            player.inventory,
            player.getHeldItemMainhand()
          );
        }
      ...
      case GUI_IDs.TRAFFIC_LIGHT_6_FRAME:
        if (
          ...
          return new TrafficLight6FrameGui(
            player.inventory,
            player.getHeldItemMainhand()
          );
        }
