...
public class OTrafficLight2FrameContainer extends BaseTrafficLightFrameContainer
{	
	public OTrafficLight2FrameContainer(InventoryPlayer inventory, ItemStack frameStack)
	{
