...
public class OTrafficLight4FrameContainer extends BaseTrafficLightFrameContainer
{
	public OTrafficLight4FrameContainer(InventoryPlayer inventory, ItemStack frameStack)
	{
