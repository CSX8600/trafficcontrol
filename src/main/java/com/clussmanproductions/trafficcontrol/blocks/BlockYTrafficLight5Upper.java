...
public class BlockYTrafficLight5Upper extends Block {
	public static PropertyInteger ROTATION = PropertyInteger.create("rotation", 0, 15);
	
	public BlockYTrafficLight5Upper() {
		super(Material.IRON);
		setRegistryName("ytraffic_light_5_upper");
		setUnlocalizedName(ModTrafficControl.MODID + ".ytraffic_light_5_upper");
		setHardness(2);
	...
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos,
		...
		return ModBlocks.ytraffic_light_5.getPickBlock(stateBelow, target, world, pos.down(), player);
	}
}
