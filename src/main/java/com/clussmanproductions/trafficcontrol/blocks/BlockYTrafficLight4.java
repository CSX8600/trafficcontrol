...
public class BlockYTrafficLight4 extends BlockBaseTrafficLight
{
	public BlockYTrafficLight4()
	{
		super("ytraffic_light_4");
	}
	...
	{
		ClientRegistry.bindTileEntitySpecialRenderer(YTrafficLight4TileEntity.class, new YTrafficLight4Renderer());
	}
	...
	{
		return new YTrafficLight4TileEntity();
	}
	
	@Override
	protected BaseItemTrafficLightFrame getItemVersionOfBlock()
	{
		return ModItems.ytraffic_light_4_frame;
	}
}
