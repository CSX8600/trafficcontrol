...
public class BlockYTrafficLight1 extends BlockBaseTrafficLight
{
	public BlockYTrafficLight1()
	{
		super("ytraffic_light_1");
	}
	...
	{
		ClientRegistry.bindTileEntitySpecialRenderer(YTrafficLight1TileEntity.class, new YTrafficLight1Renderer());
	}
	...
	{
		return new YTrafficLight1TileEntity();
	}
