...
public class BlockYTrafficLight2 extends BlockBaseTrafficLight
{
	public BlockYTrafficLight2()
	{
		super("ytraffic_light_2");
	}
	...
	{
		ClientRegistry.bindTileEntitySpecialRenderer(YTrafficLight2TileEntity.class, new YTrafficLight2Renderer());
	}
	...
	{
		return new YTrafficLight2TileEntity();
	}
	
	@Override
	protected BaseItemTrafficLightFrame getItemVersionOfBlock()
	{
		return ModItems.ytraffic_light_2_frame;
	}
}
