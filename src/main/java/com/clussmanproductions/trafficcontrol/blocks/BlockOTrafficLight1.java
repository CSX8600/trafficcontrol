...
import com.clussmanproductions.trafficcontrol.tileentity.render.OTrafficLight1Renderer;
...
import com.clussmanproductions.trafficcontrol.tileentity.render.YTrafficLight1Renderer;
...
public class BlockOTrafficLight1 extends BlockBaseTrafficLight
{
	public BlockOTrafficLight1()
	{
		super("otraffic_light_1");
	}
	...
	{
		ClientRegistry.bindTileEntitySpecialRenderer(OTrafficLight1TileEntity.class, new OTrafficLight1Renderer());
	}
	...
	{
		return new OTrafficLight1TileEntity();
	}
	
	@Override
	protected BaseItemTrafficLightFrame getItemVersionOfBlock()
	{
		return ModItems.otraffic_light_1_frame;
	}
}
