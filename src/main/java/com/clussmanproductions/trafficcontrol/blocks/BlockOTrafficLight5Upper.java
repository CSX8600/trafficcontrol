...
public class BlockOTrafficLight5Upper extends Block {
	public static PropertyInteger ROTATION = PropertyInteger.create("rotation", 0, 15);
	
	public BlockOTrafficLight5Upper() {
		super(Material.IRON);
		setRegistryName("otraffic_light_5_upper");
		setUnlocalizedName(ModTrafficControl.MODID + ".otraffic_light_5_upper");
		setHardness(2);
	...
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos,
		...
		return ModBlocks.otraffic_light_5.getPickBlock(stateBelow, target, world, pos.down(), player);
	}
}
