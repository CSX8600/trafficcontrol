...
import com.clussmanproductions.trafficcontrol.tileentity.render.OTrafficLight2Renderer;
...
import com.clussmanproductions.trafficcontrol.tileentity.render.YTrafficLight2Renderer;
...
public class BlockOTrafficLight2 extends BlockBaseTrafficLight
{
	public BlockOTrafficLight2()
	{
		super("otraffic_light_2");
	}
	...
	{
		ClientRegistry.bindTileEntitySpecialRenderer(OTrafficLight2TileEntity.class, new OTrafficLight2Renderer());
	}
	...
	{
		return new OTrafficLight2TileEntity();
	}
	
	@Override
	protected BaseItemTrafficLightFrame getItemVersionOfBlock()
	{
		return ModItems.otraffic_light_2_frame;
	}
}
