...
import com.clussmanproductions.roadstuffreborn.statewatcher.IStateWatchable;
import com.clussmanproductions.roadstuffreborn.statewatcher.StateWatcher;
...
import com.clussmanproductions.roadstuffreborn.util.MaterialCustomTransparency;
...
public class BlockStreetLightDouble extends Block implements ITileEntityProvider {
	...
	public BlockStreetLightDouble()
	{
		...
		setUnlocalizedName(ModRoadStuffReborn.MODID + ".street_light_double");
