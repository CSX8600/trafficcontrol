...
public class SafetranType3TileEntity extends TileEntity implements ILoopableSoundTileEntity {
	...
	private void handlePlaySound()
	{
		if (bellSound == null)
		{
			bellSound = new LoopableTileEntitySound(ModSounds.safetranType3Event, this, pos, 1F, 1);
		}
